...
IPv6CommunicationSocket::IPv6CommunicationSocket(const IPv6Address &ipAddress, uint16_t port, int fd_client, unsigned int timeout) :
...
IPv6CommunicationSocket::IPv6CommunicationSocket(const IPv6Address &ipAddress, uint16_t port, unsigned int timeout) :
	CommunicationSocket(ipAddress),
	port(port),
	fd_client(),
	counter(nullptr)
